...
exports.STANDARD_ROLE = exports.ADMIN_ROLE = undefined;
...
var devConfigTk = exports.devConfigTk = {
  secret: 'Andromeda'
};
...
_mongoose2.default.Promise = global.Promise; //permet d'eviter les chargements trop longs
...
// ADMIN_ROLE :
var adminOnly = [_passport2.default.authenticate('jwt', { session: false }), _admin.isAdmin];

articleRouter.route('/').post(adminOnly, _article2.default.create).get(_article2.default.articleList);
articleRouter.route('/:id').get(_article2.default.oneArticle).delete(adminOnly, _article2.default.delete).put(adminOnly, _article2.default.update);
...
exports.default = {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              _context.next = 7;
              return _article2.default.create(Object.assign({}, value));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              id = req.params.id;
              _context2.next = 4;
              return _article2.default.findByIdAndRemove(id);
            ...
            case 4:
              ...
              return _context2.abrupt('return', res.status(404).json({ err: 'no article found' }));

            case 7:
              return _context2.abrupt('return', res.json({ err: 'article removed' }));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt('return', res.status(400).json(error));

            case 6:
              _context3.next = 8;
              return _article2.default.findOneAndUpdate({ _id: id }, value, { new: true });
            ...
            case 8:
              ...
              return _context3.abrupt('return', res.status(404).json({ err: 'no article found' }));
            ...
            case 14:
              ...
              return _context3.abrupt('return', res.status(505).json(_context3.t0));
  ...
  articleList: function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(req, res) {
      var _req$query, page, perPage, options, article;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 5;
              return _article2.default.paginate({}, options);
...
var isAdmin = exports.isAdmin = function isAdmin(req, res, next) {
  if (req.user.hierarchy !== _user.ADMIN_ROLE) {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return _user4.default.create({
                ...
                hierarchy: _value.hierarchy || STANDARD_ROLE
              });
...
exports.default = {
  encryptPassword: function encryptPassword(saltyText) {
    var salt = _bcryptjs2.default.genSaltSync(10);
    return _bcryptjs2.default.hashSync(saltyText, salt);
  },
  comparePassword: function comparePassword(saltyText, encryptatedPassword) {
    return _bcryptjs2.default.compareSync(saltyText, encryptatedPassword);
  },
  validateSignup: function validateSignup(body) {
    var schema = _joi2.default.object().keys({
      ...
      hierarchy: _joi2.default.number().integer()
    });
...
var _development = __webpack_require__(7);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
  issue: function issue(payload, expiresIn) {
    return _jsonwebtoken2.default.sign(payload, _development.devConfigTk.secret, {
      expiresIn: expiresIn
    });
  }
};
...
var configJWTStrategy = exports.configJWTStrategy = function configJWTStrategy() {
  var options = {
    ...
    secretOrKey: _development.devConfigTk.secret
  };
  _passport2.default.use(new _passportJwt2.default.Strategy(options, function (payload, done) {
